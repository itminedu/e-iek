...
class EncryptionProfileListBuilder extends ConfigEntityListBuilder {
  ...
  public function render() {
    $build = parent::render();
    $build['table']['#empty'] = $this->t('No encryption profiles are available. <a href=":link">Add a profile</a>.', array(':link' => Url::fromRoute('entity.encryption_profile.add_form')->toString()));
    return $build;
  }
