       ...
       <form [formGroup]="formGroup">
        <div formArrayName="formArray">
            ...
            <div *ngFor="let region$ of regions$ | async; let i=index">
                ...
                <div *ngFor="let iek$ of region$.ieks; let j=index;" [hidden]="i !== regionActive">
                    <li class="list-group-item" >
                        <div class="row">
                            <div class="col-md-2">
                                <input type="checkbox" formControlName="{{ iek$.globalIndex }}">
                            </div>
                            <div class="col-md-10">
                                {{iek$.iek_name}}
                            </div>
    ...
    ngOnInit() {
        ...
        this.regions$ = this._ngRedux.select(state => {
            state.regions.reduce((prevRegion, region) =>{
                region.ieks.reduce((prevEpal, iek) =>{
                    this.rss.push( new FormControl(iek.selected, []));
                    return iek;
                }, {});
                return region;
            }, {});
