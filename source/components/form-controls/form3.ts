...
export default class Form3 {
    ...
    onSubmit(studentform: any) {
        ...
        this.http.post(`${AppSettings.API_ENDPOINT}/entity/iek_student`, this.student, options)
    //    this.http.post('http://eduslim2.minedu.gov.gr/drupal/entity/iek_student', this.student, options)
